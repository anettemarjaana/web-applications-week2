...
/* The function below finds the table initialized in index.html and fills it
 with 5*5 cells. The final table will be of size 5x5. 
...
function calculateWinCondition(playerno) {
  // player symbols = "x"/"o" depending on the player
